...
def configuration(parent_package="", top_path=None):
    ...
    config.add_library(
        ...
        include_dirs=["src", join("src", "ipm", "basiclu", "include"),],
        language="c",
    ...
    highs_sources = [s for s in highs_sources if pathlib.Path(s).parent.name != "mip"]
    ext = config.add_extension(
        "_highs_wrapper",
        sources=(
            [join("cython", "src", "_highs_wrapper.cxx")] + highs_sources + ipx_sources
        ),
        include_dirs=[
            # highs_wrapper
            "src",
