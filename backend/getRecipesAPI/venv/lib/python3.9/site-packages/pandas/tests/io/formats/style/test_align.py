...
class TestStylerBarAlign:
    ...
    def test_bar_align_mid_pos_and_neg(self):
        ...
        expected = {
            (0, 0): bar_grad("#d65f5f 10.0%", " transparent 10.0%",),
            (1, 0): bar_grad(),
            (2, 0): bar_grad(
                " transparent 10.0%",
                " #5fba7d 10.0%",
    ...
    def test_bar_align_mid_all_pos(self):
        ...
        expected = {
            (0, 0): bar_grad("#5fba7d 10.0%", " transparent 10.0%",),
            (1, 0): bar_grad("#5fba7d 20.0%", " transparent 20.0%",),
            (2, 0): bar_grad("#5fba7d 50.0%", " transparent 50.0%",),
            (3, 0): bar_grad("#5fba7d 100.0%", " transparent 100.0%",),
        }
    ...
    def test_bar_align_mid_all_neg(self):
        ...
        expected = {
            (0, 0): bar_grad("#d65f5f 100.0%", " transparent 100.0%",),
            (1, 0): bar_grad(
                " transparent 40.0%",
                " #d65f5f 40.0%",
                " #d65f5f 100.0%",
    ...
    def test_bar_align_left_axis_none(self):
        ...
        expected = {
            (0, 0): bar_grad(),
            (1, 0): bar_grad("#d65f5f 25.0%", " transparent 25.0%",),
            (0, 1): bar_grad("#d65f5f 50.0%", " transparent 50.0%",),
            (1, 1): bar_grad("#d65f5f 100.0%", " transparent 100.0%",),
        }
        assert result == expected
    ...
    def test_bar_align_mid_axis_none(self):
        ...
        expected = {
            ...
            (0, 1): bar_grad("#d65f5f 33.3%", " transparent 33.3%",),
            (1, 1): bar_grad(
                " transparent 33.3%",
                " #d65f5f 33.3%",
                " #d65f5f 100.0%",
    ...
    def test_bar_align_mid_vmax(self):
        ...
        expected = {
            ...
            (0, 1): bar_grad("#d65f5f 20.0%", " transparent 20.0%",),
            (1, 1): bar_grad(
                " transparent 20.0%",
                " #d65f5f 20.0%",
                " #d65f5f 60.0%",
