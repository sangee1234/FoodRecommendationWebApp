...
def kth_smallest(a: np.ndarray, k: int,) -> Any: ...  # numeric[:]  # numeric

# ----------------------------------------------------------------------
# Pairwise correlation/covariance

def nancorr(
    mat: np.ndarray, cov: bool = False, minp=None,  # const float64_t[:, :]
) -> np.ndarray: ...  # ndarray[float64_t, ndim=2]
def nancorr_spearman(
    mat: np.ndarray, minp: int = 1,  # ndarray[float64_t, ndim=2]
) -> np.ndarray: ...  # ndarray[float64_t, ndim=2]
def nancorr_kendall(
    mat: np.ndarray, minp: int = 1,  # ndarray[float64_t, ndim=2]
) -> np.ndarray: ...  # ndarray[float64_t, ndim=2]
...
def pad_inplace(
    values: np.ndarray, mask: np.ndarray, limit=None,  # algos_t[:]  # uint8_t[:]
) -> None: ...
def pad_2d_inplace(
