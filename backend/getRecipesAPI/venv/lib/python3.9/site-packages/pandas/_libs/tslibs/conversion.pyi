...
def precision_from_unit(unit: str,) -> tuple[int, int,]: ...  # (int64_t, _)
def ensure_datetime64ns(
    arr: np.ndarray, copy: bool = ...,  # np.ndarray[datetime64[ANY]]
) -> np.ndarray: ...  # np.ndarray[datetime64ns]
def ensure_timedelta64ns(
    arr: np.ndarray, copy: bool = ...,  # np.ndarray[timedelta64[ANY]]
