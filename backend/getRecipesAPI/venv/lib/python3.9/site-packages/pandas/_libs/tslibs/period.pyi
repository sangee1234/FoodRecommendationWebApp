...
def periodarr_to_dt64arr(
    periodarr: np.ndarray, freq: int,  # const int64_t[:]
) -> np.ndarray: ...  # np.ndarray[np.int64]
def period_asfreq_arr(
    arr: np.ndarray, freq1: int, freq2: int, end: bool,  # ndarray[int64_t] arr,
) -> np.ndarray: ...  # np.ndarray[np.int64]
def get_period_field_arr(
    field: str, arr: np.ndarray, freq: int,  # const int64_t[:]
) -> np.ndarray: ...  # np.ndarray[np.int64]
def from_ordinals(
    values: np.ndarray, freq: Frequency,  # const int64_t[:]
) -> np.ndarray: ...  # np.ndarray[np.int64]
def extract_ordinals(
    values: np.ndarray, freq: Frequency | int,  # np.ndarray[object]
) -> np.ndarray: ...  # np.ndarray[np.int64]
def extract_freq(values: np.ndarray,) -> BaseOffset: ...  # np.ndarray[object]
