...
def dt64arr_to_periodarr(
    stamps: np.ndarray, freq: int, tz: tzinfo | None,  # const int64_t[:]
) -> np.ndarray: ...  # np.ndarray[np.int64, ndim=1]
def is_date_array_normalized(
    stamps: np.ndarray, tz: tzinfo | None = None,  # const int64_t[:]
) -> bool: ...
def normalize_i8_timestamps(
    stamps: np.ndarray, tz: tzinfo | None,  # const int64_t[:]
