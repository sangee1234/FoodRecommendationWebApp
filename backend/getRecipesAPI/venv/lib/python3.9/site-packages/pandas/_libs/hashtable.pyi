...
class HashTable:
    ...
    def map_locations(
        self, values: np.ndarray,  # np.ndarray[subclass-specific]
    ) -> None: ...
    def lookup(
        self, values: np.ndarray,  # np.ndarray[subclass-specific]
    ...
    def unique(
        ...
        np.ndarray, np.ndarray,  # np.ndarray[subclass-specific]  # np.ndarray[np.intp],
...
class Int64HashTable(HashTable):
    ...
    def get_labels_groupby(
        self, values: np.ndarray,  # const int64_t[:]
    ) -> tuple[
        np.ndarray, np.ndarray,  # np.ndarray[np.intp]  # np.ndarray[np.int64]
    ]: ...
...
def mode_int64(
    values: np.ndarray, dropna: bool,  # const int64_t[:] values
) -> np.ndarray: ...  # np.ndarray[np.int64]
def value_count_int64(
    values: np.ndarray, dropna: bool,  # const int64_t[:]
...
def ismember(
    arr: np.ndarray, values: np.ndarray,
) -> np.ndarray: ...  # np.ndarray[bool]
