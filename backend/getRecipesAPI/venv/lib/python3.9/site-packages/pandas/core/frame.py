...
class DataFrame(NDFrame, OpsMixin):
    ...
    @classmethod
    def from_dict(
        cls, data, orient: str = "columns", dtype: Dtype | None = None, columns=None,
    ) -> DataFrame:
        """
    ...
    def to_numpy(
        self, dtype: NpDtype | None = None, copy: bool = False, na_value=lib.no_default,
    ) -> np.ndarray:
        """
...
"""
    ...
    def _gotitem(
        self, key: IndexLabel, ndim: int, subset: FrameOrSeriesUnion | None = None,
    ) -> FrameOrSeriesUnion:
        """
    ...
    def _join_compat(
        ...
        if isinstance(other, DataFrame):
            if how == "cross":
                return merge(
                    self, other, how=how, on=on, suffixes=(lsuffix, rsuffix), sort=sort,
                )
            return merge(
                self,
                other,
    ...
    def _reduce(
        ...
        **kwds,
        ...
        dtype_is_dt = np.array(
            [is_datetime64_any_dtype(dtype) for dtype in own_dtypes], dtype=bool,
        )
