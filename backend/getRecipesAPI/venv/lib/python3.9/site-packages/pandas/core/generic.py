...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    @classmethod
    def _init_mgr(
        cls, mgr: Manager, axes, dtype: Dtype | None = None, copy: bool_t = False,
    ) -> Manager:
    ...
    @final
    def _where(
        self, cond, other=np.nan, inplace=False, axis=None, level=None, errors="raise",
    ):
        """
        ...
        if inplace:
            ...
            new_data = self._mgr.where(
                other=other, cond=cond, align=align, errors=errors,
            )
            result = self._constructor(new_data)
    ...
    def mask(
        ...
        return self.where(
            ~cond, other=other, inplace=inplace, axis=axis, level=level, errors=errors,
        )
